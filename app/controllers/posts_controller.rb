class PostsController < ApplicationController
  ...
  def index
    ...
    @pagy, @posts = pagy(@q.result(distinct: true).with_attached_images.includes(user: { avatar_attachment: { blob: :variant_records } }).order(created_at: :desc)) # rubocop:disable Metrics/LineLength
  end
